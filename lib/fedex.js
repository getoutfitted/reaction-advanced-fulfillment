...
AdvancedFulfillment.FedExApi.getFedexTransitTime = function (address) {
  ...
  if (!advancedFulfillment || !advancedFulfillment.settings || !advancedFulfillment.settings.fedex) {
  ...
  let fedex = new Fedex({
    'environment': advancedFulfillment.settings.fedex.liveApi ? 'live' : 'sandbox',
    'key': advancedFulfillment.settings.fedex.key,
    'password': advancedFulfillment.settings.fedex.password,
    'account_number': advancedFulfillment.settings.fedex.accountNumber,
    'meter_number': advancedFulfillment.settings.fedex.meterNumber,
    'imperial': true
  });
